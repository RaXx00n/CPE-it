...
# Run the query and save the results as a JSON file
Get-WmiObject -Query $query | Select-Object Name, Version, Vendor, InstallDate, InstallLocation | ConvertTo-Json | Out-File -FilePath ".\gotWMIobject.json"
